        ...
        >
          ...
          <div className="grid grid-cols-2 gap-8">
            <div data-testid="section-ushers">
              ...
              <p className="text-white font-normal italic text-xs">Nico shane balisi</p>
          ...
          <div data-testid="section-ring-bearers">
            ...
            <div className="grid grid-cols-2 gap-x-8">
              ...
              <p className="text-white font-normal italic text-xs">Khayr bryce Filio</p>
            </div>
          </div>
          ...
          <div data-testid="section-officiant">
            <p className="text-white font-normal italic text-xs">Rev. Fr. Joven Abaño</p>
