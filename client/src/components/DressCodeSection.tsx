          ...
          >
            <div className="bg-card/30 border border-border rounded-xl p-8 shadow-soft hover-elegant transition-all duration-500 h-full relative">
              <div className="text-center">
                ...
                />
                <div className="mt-6">
                  <p className="text-sm text-foreground/80 mb-3 text-center">Emerald Green</p>
                  <div className="flex justify-center gap-3">
                    <div className="w-12 h-12 rounded-full border-2 border-border shadow-md" style={{ backgroundColor: '#50C878' }}></div>
                    <div className="w-12 h-12 rounded-full border-2 border-border shadow-md" style={{ backgroundColor: '#046307' }}></div>
                    <div className="w-12 h-12 rounded-full border-2 border-border shadow-md" style={{ backgroundColor: '#28a745' }}></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-base font-display font-semibold text-foreground mb-2">
                    Ninang & Ninong: Formal Attire (Emerald Green)
                  </h4>
                  <p className="text-sm text-foreground/70">
                    Please wear formal attire in emerald green for this special occasion.
                  </p>
                </div>
              </div>
            </div>
